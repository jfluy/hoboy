...
pet <- rnorm(n_days, mean = 900, sd = 500)
...
booboo <- calc_mean_summer_val(clim, clim$aet)
...
return(list(Danger_days = one, Average_Drought = av_drought2))

}

calc_drought_risk(clim, clim$aet, clim$pet, 2000)
